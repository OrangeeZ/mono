...
void mono_profiler_finalizer_thread_start_event() MONO_INTERNAL;
void mono_profiler_domain_unload_thread_event (MonoProfilerDomainUnloadThreadEvent event) MONO_INTERNAL;
